...
for i = 1:numSamples
    ...
    set_param(['singlePhasingFault','/', 'VoltageSource1'], 'Amplitude', num2str(voltageValue));
    set_param(['singlePhasingFault','/','VoltageSource2'], 'Amplitude', num2str(voltageValue));
    set_param(['singlePhasingFault','/','VoltageSource3'], 'Amplitude', num2str(voltageValue));
...
save('ann_dataset_singlePhasingFault.mat', 'inputFeatures', 'targetValues');